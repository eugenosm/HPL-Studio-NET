...
namespace HPLStudio
{
    ...
    public class IniFile
    {
                                ...
                                string defaultValue)
        {
            ...
            var result = new StringBuilder(IniFile.MaxSectionSize);
        ...
        public short GetInt16(string sectionName,
                              ...
                              short  defaultValue)
        {
            var result = GetInt32(sectionName, keyName, defaultValue);
        ...
        public List<KeyValuePair<string, string>> GetSectionValuesAsList(string sectionName)
        {
            ...
            var result = new List<KeyValuePair<string, string>>(keyValuePairs.Length);
            result.AddRange(from t in keyValuePairs 
                let equalSignPos = t.IndexOf('=') 
                let key = t.Substring(0, equalSignPos) 
                let value = t.Substring(equalSignPos + 1, t.Length - equalSignPos - 1) 
        ...
        public Dictionary<string, string> GetSectionValues(string sectionName)
        {
            ...
            foreach (var keyValuePair in keyValuePairs.Where(keyValuePair => !result.ContainsKey(keyValuePair.Key)))
            {
